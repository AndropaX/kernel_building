...
TARGET_KERNEL_SOURCE := kernel/xiaomi/msm8992oc
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/xiaomi/aqualibra/bluetooth
...
TARGET_BOARD_INFO_FILE := device/xiaomi/aqualibra/board-info.txt
TARGET_NO_RPC := true

BOARD_EGL_CFG := device/xiaomi/aqualibra/egl.cfg
...
TARGET_RECOVERY_FSTAB = device/xiaomi/aqualibra/fstab.libra

TARGET_RELEASETOOLS_EXTENSIONS := device/xiaomi/aqualibra
...
BOARD_SEPOLICY_DIRS += \
    device/xiaomi/aqualibra/sepolicy
