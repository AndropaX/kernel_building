...
PRODUCT_COPY_FILES += \
    device/xiaomi/aqualibra/init.libra.rc:root/init.libra.rc \
    device/xiaomi/aqualibra/init.aqua.rc:root/init.aqua.rc \
    device/xiaomi/aqualibra/init.recovery.libra.rc:root/init.recovery.libra.rc \
    device/xiaomi/aqualibra/init.libra.usb.rc:root/init.libra.usb.rc \
    device/xiaomi/aqualibra/fstab.libra:root/fstab.libra \
    device/xiaomi/aqualibra/ueventd.libra.rc:root/ueventd.libra.rc \
    device/xiaomi/aqualibra/init.libra.ramdump.rc:root/init.libra.ramdump.rc
...
PRODUCT_COPY_FILES += \
    device/xiaomi/aqualibra/init.libra.diag.rc.userdebug:root/init.libra.diag.rc \
    device/xiaomi/aqualibra/init.libra.misc.rc.userdebug:root/init.libra.misc.rc
else
PRODUCT_COPY_FILES += \
    device/xiaomi/aqualibra/init.libra.diag.rc.user:root/init.libra.diag.rc \
    device/xiaomi/aqualibra/init.libra.misc.rc.user:root/init.libra.misc.rc
endif
